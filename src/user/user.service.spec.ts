...
//     const newUserWithEmail = await userService.createUserWithEmail(createUserWithEmailInput);
//     expect(newUserWithEmail.data['email']).toBe(createUserWithEmailInput.email);
//   });

//   it('should create account with phone number', async () => {
//     const newUserWithPhone = await userService.createUserWithPhone(createUserWithPhoneNumberInput);
//     expect(newUserWithPhone.data['email']).toBe(createUserWithPhoneNumberInput.email);
//     expect(newUserWithPhone.data['phone']).toBe(createUserWithPhoneNumberInput.phone);
//   });

//   it('should generate otp when create new user with email', async () => {
//     const newUserWithEmail = await userService.createUserWithEmail(createUserWithEmailInput);
//     expect(newUserWithEmail.data['email']).toBe(createUserWithEmailInput.email);
//     expect(newUserWithEmail.data['emailConfirmationOtp']).toBe(configService.get(configConstant.otp));
//   });
...
//     expect(newUserWithPhone.data['email']).toBe(createUserWithPhoneNumberInput.email);
//     expect(newUserWithPhone.data['phone']).toBe(createUserWithPhoneNumberInput.phone);
//     expect(newUserWithPhone.data['phoneNumberConfirmationOtp']).toBe(configService.get(configConstant.otp));
//   });

//   it('should verify otp for email', async () => {
//     await userService.createUserWithEmail(createUserWithEmailInput);
//     const otpVerificationForEmail = await userService.otpVerification(otpVerificationForEmailDtoInput);
...
//     const otpVerificationForPhoneNumber = await userService.otpVerification(otpVerificationForPhoneNumberDtoInput);
...
//     );
//     expect(resendOtpVerificationForPhoneNumber.data['isPhoneVerify']).toBe(true);
//   });
...
//       `Otp has been sent to ****${mockUserDetails.phone.slice(mockUserDetails.phone.length - 3)}`,
//     );
//   });
// });
...
//     await userService.createUserWithPhone(createUserWithPhoneNumberInput);
//     expect(async () => {
//       await userService.otpVerification(wrongOtpVerificationForPhoneNumberDtoInput);
//     }).rejects.toThrow();
//   });
// });
